...
namespace BusinessLogic
{
    public class PrimaryMembershipProvider : MembershipProvider
    {
        ...
        public MembershipCreateStatus CreateUser(string userName, string password, string email, string firstName, string surname)
        {
            ...
            usersRepository.CreateUser(userName, password, email, firstName, surname);
